...
- api_model: `Vendor2/GPT-5.3-codex`
- reasoning_effort: `medium`
- run_dir: `runs/Vendor2__GPT-5.3-codex`
- workflow_doc: `workflow_v4.md`
- benchmark_state: `benchmark_state.json`
- write the report to: `runs/Vendor2__GPT-5.3-codex/report.md`
