...
- Do not web search solely to fill manufacturer when the device family and description are already coherent; leaving manufacturer empty is acceptable.
...
- batch_name: `v4_batch_006`
- batch_dir: `Uni-Lab-OS/community_drivers/_info_enrichment_workflow/batches/v4_batch_006`
- devices_file: `Uni-Lab-OS/community_drivers/_info_enrichment_workflow/batches/v4_batch_006/devices.txt`
- manifest: `Uni-Lab-OS/community_drivers/_info_enrichment_workflow/batches/v4_batch_006/manifest.json`
...
- write the report to: `Uni-Lab-OS/community_drivers/_info_enrichment_workflow/batches/v4_batch_006/report.md`
